function [theta_best_modelo, best_lambda, tab_acierto_T, tab_acierto_V] = regularizacion(K, X, y, lambda_list)
    ...
    for lambda = lambda_list
        ...
        if tasa_acierto_V > best_tasa_acierto_V
            best_tasa_acierto_V = tab_acierto_V;
            best_lambda = lambda;
        end
    ...
    theta_best_modelo = LearnerRegularizado(X, y, best_lambda);
end
